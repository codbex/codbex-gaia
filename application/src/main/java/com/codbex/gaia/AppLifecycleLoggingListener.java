...
class AppLifecycleLoggingListener implements ApplicationListener<ApplicationEvent>, DisposableBean {
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        ...
        if (event instanceof ApplicationReadyEvent) {
            ...
            log("Start time: [{}] milliseconds. Init time: [{}] milliseconds", (currentTime - GaiaApplication.getStartedAt()),
    ...
    public void destroy() {
        ...
        log("Application started at [{}] and has been running for [{}] milliseconds", GaiaApplication.getStartedAt(),
                (System.currentTimeMillis() - GaiaApplication.getStartedAt()));
    }
}
